      ...
      <div className="container mx-auto px-4 sm:px-6 py-6 sm:py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-10 lg:gap-16">
          ...
          >
            ...
            <p className="font-heading text-xl sm:text-2xl font-semibold text-primary mb-6">
            ...
            <div className="mb-6 sm:mb-8">
              <h3 className="font-body text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-3">
                Size{" "}
                {selectedSize && (
                  <span className="text-foreground ml-1">— {selectedSize}</span>
                )}
              </h3>
              <div className="flex flex-wrap gap-2">
                {product.sizes.map((size) => (
                  <button
                    ...
                    className={`px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm border rounded-sm transition-all ${
                      selectedSize === size
              ...
              <div className="flex gap-2 sm:gap-3">
                {product.colors.map((color) => (
                  <button
                    ...
                    className={`relative h-8 w-8 sm:h-9 sm:w-9 rounded-full border-2 transition-all ${
                      selectedColor === color
            ...
            <button
              ...
              disabled={!canAdd}
              className={`w-full py-2.5 sm:py-3.5 font-body text-xs sm:text-sm font-semibold tracking-wider uppercase transition-all ${
                canAdd
